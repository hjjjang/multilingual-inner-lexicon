...
if __name__ == "__main__":
    ...
    patchscope = PatchScope(
        ...
        # translation_prompt="What is this Korean word '[word]' in English? Respond only with the translated English word.",
        translation_prompt=f"This {SOURCE_LANGUAGE} word '[word]' in {TARGET_LANGUAGE} is:",
        # translation_prompt="이 독일어 단어 '[word]'는 한국어로 뭐야? 한국어로 번역된 단어만 답해줘",
    ...
    output_path = f"/home/hyujang/multilingual-inner-lexicon/output/RQ2/PatchScope/{MODEL_NAME.split("/")[-1]}_{SOURCE_LANGUAGE}_to_{TARGET_LANGUAGE}_EnglishPrompt.csv"
